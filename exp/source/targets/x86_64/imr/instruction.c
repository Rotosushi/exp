...
static void print_x86_64_instruction_A(String *buffer,
                                       StringView mnemonic,
    ...
    print_x86_64_operand(
        buffer, instruction.A_kind, instruction.A_data, context);
}

static void print_x86_64_instruction_AB(String *buffer,
                                        StringView mnemonic,
                                        x86_64_Instruction instruction,
                                        Context *context) {
    u8 size = x86_64_operand_size(instruction.A_kind, instruction.A_data);
    print_x86_64_mnemonic(buffer, mnemonic, size);
    print_x86_64_operand(
        buffer, instruction.B_kind, instruction.B_data, context);
